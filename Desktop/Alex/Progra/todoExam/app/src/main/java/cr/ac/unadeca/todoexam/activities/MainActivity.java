...
public class MainActivity extends AppCompatActivity {
    ...
    public static class ToDoAdapter extends RecyclerView.Adapter<TodoViewHolder> {
        ...
        private String ActividadaString(ToDoTable todo){
            ...
            String html = "<a><big><b> <font color=\""+ color +"\">" +"Nombre Completo: "+ todo.nombre + " " + todo.apellido + "</b></big>";
            html+= "<br>" + "Número de Cédula: " + todo.cedula+"</p>";
            html+= "<br>" + "Codigo Empleado: " + todo.codigoEmple+"</p>";
            html+= "<br>" + "Departamento: " +todo.departamento+"</p>";
            html+= "<br>" + "Telefono: " + todo.tel + "</p>" + "</a>";
